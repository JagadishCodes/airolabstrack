...
<body>
    ...
    <text dy="6" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="17" font-weight="700">
        ...
        <div class="slide s5">
            ...
            <div class="pkg-grid" style="display:grid;grid-template-columns:repeat(3,1fr);gap:80px;padding-bottom:1.5rem;">

                <!-- SILVER -->
                <div class="pkg-card" onclick="openSharedModal('silver')" style="cursor:pointer;background:#fff;border:2px solid #a0a0a0;border-radius:14px;padding:1.5rem 1.25rem;display:flex;flex-direction:column;align-items:center;gap:12px;">
                <span style="font-size:11px;font-weight:700;letter-spacing:0.09em;padding:7px 18px;border-radius:20px;background:linear-gradient(135deg,#e8e8e8 0%,#b0b0b0 30%,#f5f5f5 50%,#9a9a9a 70%,#d8d8d8 100%);color:#3a3a3a;border:1px solid #aaa;">SILVER PACKAGE</span>
                <div style="width:90px;height:90px;border-radius:50%;border:3px solid #a0a0a0;background:#fff;display:flex;align-items:center;justify-content:center;">
                    <svg width="56" height="56" viewBox="0 0 80 90" fill="none">
                    <ellipse cx="10" cy="36" rx="7" ry="9" fill="#c8c8d8" stroke="#aaaabc" stroke-width="1.5"/>
                    <ellipse cx="70" cy="36" rx="7" ry="9" fill="#c8c8d8" stroke="#aaaabc" stroke-width="1.5"/>
                    <ellipse cx="10" cy="36" rx="4" ry="5.5" fill="#9ab0cc"/>
                    <ellipse cx="70" cy="36" rx="4" ry="5.5" fill="#9ab0cc"/>
                    <rect x="16" y="10" width="48" height="46" rx="20" fill="#dcdce8" stroke="#bbbbc8" stroke-width="1.2"/>
                    <rect x="20" y="15" width="40" height="28" rx="10" fill="#111827"/>
                    <circle cx="32" cy="29" r="6" fill="#33d4f0"/>
                    <circle cx="48" cy="29" r="6" fill="#33d4f0"/>
                    <circle cx="33.5" cy="27.5" r="2" fill="white" opacity="0.5"/>
                    <circle cx="49.5" cy="27.5" r="2" fill="white" opacity="0.5"/>
                    <line x1="33" y1="40" x2="47" y2="40" stroke="#33d4f0" stroke-width="2" stroke-linecap="round"/>
                    <line x1="40" y1="10" x2="40" y2="5" stroke="#aaaabc" stroke-width="2" stroke-linecap="round"/>
                    <circle cx="40" cy="4" r="2.5" fill="#9ab0cc"/>
                    <rect x="34" y="56" width="12" height="6" rx="3" fill="#c8c8d8"/>
                    <ellipse cx="40" cy="76" rx="18" ry="14" fill="#dcdce8" stroke="#bbbbc8" stroke-width="1.2"/>
                    <ellipse cx="14" cy="74" rx="7" ry="12" fill="#dcdce8" stroke="#bbbbc8" stroke-width="1.2" transform="rotate(-15 14 74)"/>
                    <ellipse cx="66" cy="74" rx="7" ry="12" fill="#dcdce8" stroke="#bbbbc8" stroke-width="1.2" transform="rotate(15 66 74)"/>
                    </svg>
                </div>
                <hr style="width:100%;border:none;border-top:1px solid #e0e0e0;margin:4px 0;"/>
                <p class="pkg-agents-num">20</p>
                <p class="pkg-agents-label">AGENTS</p>
                <p class="pkg-agents-duration">2 months</p>
                <span class="pkg-card-hint">View details →</span>
                </div>

                <!-- GOLD -->
                <div class="pkg-card" onclick="openSharedModal('gold')" style="cursor:pointer;background:#fff;border:3px solid #C9A227;border-radius:14px;padding:1.5rem 1.25rem;display:flex;flex-direction:column;align-items:center;gap:12px;">
                <span style="font-size:11px;font-weight:700;letter-spacing:0.09em;padding:7px 18px;border-radius:20px;background:linear-gradient(135deg,#f5d060 0%,#c8900a 25%,#f9e27a 50%,#b07800 70%,#e8c040 100%);color:#3a2000;border:1px solid #a07010;">GOLD PACKAGE</span>
                <div style="width:100px;height:100px;border-radius:50%;border:3px solid #C9A227;background:#fff;display:flex;align-items:center;justify-content:center;">
                    <svg width="64" height="64" viewBox="0 0 80 90" fill="none">
                    <ellipse cx="10" cy="36" rx="7" ry="9" fill="#e8c87a" stroke="#C9A227" stroke-width="1.5"/>
                    <ellipse cx="70" cy="36" rx="7" ry="9" fill="#e8c87a" stroke="#C9A227" stroke-width="1.5"/>
                    <ellipse cx="10" cy="36" rx="4" ry="5.5" fill="#C9A227"/>
                    <ellipse cx="70" cy="36" rx="4" ry="5.5" fill="#C9A227"/>
                    <rect x="16" y="10" width="48" height="46" rx="20" fill="#f5e6b8" stroke="#C9A227" stroke-width="1.2"/>
                    <rect x="20" y="15" width="40" height="28" rx="10" fill="#2d1f00"/>
                    <circle cx="32" cy="29" r="6" fill="#EF9F27"/>
                    <circle cx="48" cy="29" r="6" fill="#EF9F27"/>
                    <circle cx="33.5" cy="27.5" r="2" fill="white" opacity="0.5"/>
                    <circle cx="49.5" cy="27.5" r="2" fill="white" opacity="0.5"/>
                    <line x1="33" y1="40" x2="47" y2="40" stroke="#EF9F27" stroke-width="2" stroke-linecap="round"/>
                    <line x1="40" y1="10" x2="40" y2="5" stroke="#C9A227" stroke-width="2" stroke-linecap="round"/>
                    <circle cx="40" cy="4" r="2.5" fill="#EF9F27"/>
                    <rect x="34" y="56" width="12" height="6" rx="3" fill="#e8c87a"/>
                    <ellipse cx="40" cy="76" rx="18" ry="14" fill="#f5e6b8" stroke="#C9A227" stroke-width="1.2"/>
                    <ellipse cx="14" cy="74" rx="7" ry="12" fill="#f5e6b8" stroke="#C9A227" stroke-width="1.2" transform="rotate(-15 14 74)"/>
                    <ellipse cx="66" cy="74" rx="7" ry="12" fill="#f5e6b8" stroke="#C9A227" stroke-width="1.2" transform="rotate(15 66 74)"/>
                    </svg>
                </div>
                <hr style="width:100%;border:none;border-top:1px solid #e0e0e0;margin:4px 0;"/>
                ...
                <!-- PLATINUM -->
                <div class="pkg-card" onclick="openSharedModal('platinum')" style="cursor:pointer;background:#fff;border:2px solid #7888a8;border-radius:14px;padding:1.5rem 1.25rem;display:flex;flex-direction:column;align-items:center;gap:12px;">
                <span style="font-size:11px;font-weight:700;letter-spacing:0.09em;padding:7px 18px;border-radius:20px;background:linear-gradient(135deg,#e0e8f0 0%,#8898b0 25%,#d0dce8 50%,#6a7e98 70%,#b8cad8 100%);color:#1a2030;border:1px solid #7888a8;">PLATINUM PACKAGE</span>
                <div style="width:90px;height:90px;border-radius:50%;border:3px solid #7888a8;background:#fff;display:flex;align-items:center;justify-content:center;">
                    <svg width="56" height="56" viewBox="0 0 80 90" fill="none">
                    <ellipse cx="10" cy="36" rx="7" ry="9" fill="#d0d0d8" stroke="#9E9E9E" stroke-width="1.5"/>
                    <ellipse cx="70" cy="36" rx="7" ry="9" fill="#d0d0d8" stroke="#9E9E9E" stroke-width="1.5"/>
                    <ellipse cx="10" cy="36" rx="4" ry="5.5" fill="#9E9E9E"/>
                    <ellipse cx="70" cy="36" rx="4" ry="5.5" fill="#9E9E9E"/>
                    <rect x="16" y="10" width="48" height="46" rx="20" fill="#e8e8ee" stroke="#9E9E9E" stroke-width="1.2"/>
                    <rect x="20" y="15" width="40" height="28" rx="10" fill="#1a1a2e"/>
                    <circle cx="32" cy="29" r="6" fill="#b0b8cc"/>
                    <circle cx="48" cy="29" r="6" fill="#b0b8cc"/>
                    <circle cx="33.5" cy="27.5" r="2" fill="white" opacity="0.5"/>
                    <circle cx="49.5" cy="27.5" r="2" fill="white" opacity="0.5"/>
                    <line x1="33" y1="40" x2="47" y2="40" stroke="#b0b8cc" stroke-width="2" stroke-linecap="round"/>
                    <line x1="40" y1="10" x2="40" y2="5" stroke="#9E9E9E" stroke-width="2" stroke-linecap="round"/>
                    <circle cx="40" cy="4" r="2.5" fill="#b0b0b8"/>
                    <rect x="34" y="56" width="12" height="6" rx="3" fill="#d0d0d8"/>
                    <ellipse cx="40" cy="76" rx="18" ry="14" fill="#e8e8ee" stroke="#9E9E9E" stroke-width="1.2"/>
                    <ellipse cx="14" cy="74" rx="7" ry="12" fill="#e8e8ee" stroke="#9E9E9E" stroke-width="1.2" transform="rotate(-15 14 74)"/>
                    <ellipse cx="66" cy="74" rx="7" ry="12" fill="#e8e8ee" stroke="#9E9E9E" stroke-width="1.2" transform="rotate(15 66 74)"/>
                    </svg>
                </div>
                <hr style="width:100%;border:none;border-top:1px solid #e0e0e0;margin:4px 0;"/>
...
/*             padding: clamp(24px, 4vh) 48px; */
    ...
    <section class="tt-faq-section" id="trinity-faq">
        ...
        <div class="tt-faq-grid" id="faqAccordionGrid">
            <div class="tt-faq-col" id="faqColLeft"></div>
            <div class="tt-faq-col" id="faqColRight"></div>
        </div>
    ...
    (function () {
        var faqData = [
            {
                q: "What is Airo's Agentic AI Trinity© Package?",
                a: "Airo's Agentic AI Trinity© Package is an AI Use Case Lifecycle Management system that operationalizes enterprise agentic AI. It combines deployment, governance, and continuous evolution into one managed framework so enterprises move from pilots to production-grade AI systems."
            },
            {
                q: "What is AI Use Case Lifecycle Management?",
                a: "AI Use Case Lifecycle Management is the end-to-end discipline of selecting, building, deploying, governing, and evolving AI agents and workflows across the enterprise. It ensures AI systems are continuously aligned to business outcomes, securely integrated, and optimized for production operations."
            },
            {
                q: "How long does it take to deploy the first AI system with the Trinity Package?",
                a: "Most enterprises deploy their first governed AI system in approximately 8 weeks—covering discovery, design, deployment, and go-live. The exact timeline depends on use-case complexity, data readiness, and integration scope."
            },
            {
                q: "How does the fixed-price model work? What is included and what is not?",
                a: "The fixed-price model covers a defined scope: use-case discovery, design, deployment, governance setup, and initial go-live. Ongoing agent operations, major scope changes, and custom integrations beyond the agreed scope are handled via defined change orders or managed services."
            },
            {
                q: " Who owns the AI agents and IP built under the Trinity Package?",
                a: "Clients retain ownership of the AI agents and IP built under the Trinity Package. Airo provides the lifecycle framework and operational management, while the enterprise controls its data, models, and output."
            },
            {
                q: "What is a Discovery Workshop and what does it deliver?",
                a: "A Discovery Workshop identifies high-impact, feasible AI use cases and produces a scoped blueprint: target workflows, data requirements, integration points, governance guardrails, and a deployment plan. It's the first step toward a production-ready AI system."
            },
            {
                q: "How is the Trinity Package different from building an in-house AI team or using a pay-per-agent model?",
                a: "The Trinity Package delivers a managed lifecycle system with fixed pricing, governance, and continuous evolution—without the overhead of hiring an in-house team or the unpredictability of pay-per-agent models. It's a turnkey path to production that retains IP, reduces risk, and scales reliably."
            },
            {
                q: "What is pilot purgatory in enterprise AI and how do you escape it?",
        ...
        var colLeft = document.getElementById("faqColLeft");
        var colRight = document.getElementById("faqColRight");
        if (!colLeft || !colRight) return;

        faqData.forEach(function (item, index) {
            var card = document.createElement("div");
            card.className = "tt-faq-item";
            card.innerHTML =
                '<div class="tt-faq-question" role="button" tabindex="0" aria-expanded="false">' +
                    '<span class="tt-faq-question-text">' + item.q + '</span>' +
                    '<span class="tt-faq-icon" aria-hidden="true">' +
                ...
                '<div class="tt-faq-answer" role="region">' +
                    '<div style="min-height: 0;">' +
                        '<div class="tt-faq-answer-inner">' +
                            ...
                            '<p class="tt-faq-answer-text">' + item.a + '</p>' +
                        '</div>' +
                    '</div>' +
                '</div>';
            ...
            function toggle() {
                ...
                /* Close all others in BOTH columns */
            ...
            /* Distribute alternately to left and right columns */
            if (index % 2 === 0) {
