...
<section class="s-ecosystem">
  ...
  <div class="eco-logo-item">
    <img src="https://staging.airolabs.ai/wp-content/uploads/2026/05/openai.png" alt="OpenAI" loading="lazy">
  </div>

  <div class="eco-logo-item">
    <img src="https://staging.airolabs.ai/wp-content/uploads/2026/05/anthropic-2.png" alt="Anthropic" loading="lazy">
  </div>

  <div class="eco-logo-item">
    <img src="https://staging.airolabs.ai/wp-content/uploads/2026/05/vertexai-color.png" alt="Google" loading="lazy">
  </div>

  <div class="eco-logo-item">
    <img src="https://staging.airolabs.ai/wp-content/uploads/2026/05/copilot-color.png" alt="Microsoft" loading="lazy">
  </div>

  <div class="eco-logo-item">
    <img src="https://staging.airolabs.ai/wp-content/uploads/2026/05/bedrock-color.png" alt="Amazon" loading="lazy">
  </div>

  <div class="eco-logo-item">
    <img src="https://staging.airolabs.ai/wp-content/uploads/2026/05/cursor-3-1.png" alt="Cursor" loading="lazy">
  </div>
    ...
    tabTitles.forEach(title => {
        ...
        title.addEventListener("click", function () {
            ...
            if (this.classList.contains("ai-active")) {
                ...
                if (contentToShow) {
                    contentToShow.classList.remove("ai-active");
                }
