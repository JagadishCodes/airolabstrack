		...
		<div class="listing-blog-banner">
			...
			<div class="cs-row2">
				...
				<div class="cs-detail5">
					<img src="/wp-content/uploads/2024/05/shp-triangle-3.png" alt="Banner" class="img_width">
				</div>
			</div>
		</div>
	</div>
                	...
                	<div class="select-dropdown">
                    	<button href="#" role="button" id="blogtype" data-value="" data-name="Type" class="select-dropdown__button">
                         ...
                         <ul class="select-dropdown__list blogtype">
							 ...
							 <li data-taxname="<?php echo esc_attr($taxonomy2); ?>" data-value="white-paper" class="select-dropdown__list-item blogitem">White Papers</li>
                         </ul>
                    </div>
                 </div>
             </div>	
	...
	<div class="container fpost">
		<div class="featured-blog-cs">
			 ...
			 $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
				...
				'posts_per_page' => 1, 
				'order' => 'DESC',  'paged' => $paged,  'orderby' => 'ID',         // Sets the number of posts to retrieve per page. '-1' means all posts.
					);
	...
	<div class="container">
		<div class="blog-main listing-blog-main">
			 ...
			 $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
				...
				'post_type' => 'blog',           // Specifies the post type to query, in this case, 'blog'
				'posts_per_page' => 6, 
				'order' => 'DESC',  'paged' => $paged, 'offset' =>1,  'orderby' => 'ID',         // Sets the number of posts to retrieve per page. '-1' means all posts.
					);
						...
						?>
							...
							<?php if (has_post_thumbnail()) { ?>
								<div class="post-thumbnail">
									<?php the_post_thumbnail('thumbnail'); // You can specify the image size you want to use here ?>
								</div>
							<?php } ?>
								</div>
							<?php
