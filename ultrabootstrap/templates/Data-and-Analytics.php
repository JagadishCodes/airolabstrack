...
.services-sec .services-inner:nth-child(2) .dirction-arrow img {  transform: rotate(90deg); }
.services-sec .services-inner:nth-child(3) .dirction-arrow img {  transform: rotate(270deg); }
.services-sec .services-inner:nth-child(4) .dirction-arrow img {  transform: rotate(180deg); }
	...
	@media(max-width: 767.98px){
		...
		.services-sec .services-inner .dirction-arrow img{ width: 15%; }
		.page-id-766 .services-sec .services-inner p{ width: 100%;  }
		.services-sec .services-inner p, #data-sec3 .services-inner h3{ width: 95%; }
	}
	...
	<div class="container">
		<div class="row">
			<div class="col-md-5 col-sm-12 values-left p-0 bl">
				...
				<h2 class=""><a href="<?php echo $video['website_link']; ?>" target="_blank"><?php echo $video['website_name']; ?></a></h2>
			</div>
			<div class="col-md-7 col-sm-12 p-0">
				<div class="iframe-vid-wrap">
					<iframe 
src="<?php echo $video['iframe_code']; ?>" 
		...
		<div class="row services-main">
			<?php foreach ($section_3['data_architecture'] as $key => $dataval) { ?>
				<div class="col-md-6 col-lg-4 col-sm-6 services-inner">
					<img src="<?php echo $dataval['icon']; ?>" alt="<?php echo esc_html($dataval['title']); ?>"  loading="lazy">
		...
		<div class="row services-main">
			<?php foreach ($section_3['data_architecture'] as $key => $datavall) { ?>
				<div class="col-md-6 col-lg-6 col-sm-6 col-6 services-inner">
					<img src="<?php echo $datavall['icon']; ?>" alt="<?php echo esc_html($datavall['title']); ?>" loading="lazy">
...
<section class="blog-sec">
	<div class="container">
        ...
        <div class="result-num">
            ...
            <span class="num-suf"><?php echo $nums['suffix']; ?></span> </div>
