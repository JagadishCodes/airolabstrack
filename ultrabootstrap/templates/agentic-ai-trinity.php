<?php
/**
 * Template Name: Agentic AI Trinity Package
    ...
    <div id="stage">
        <div class="slide s0 active">
            ...
            <div class="hero-inner">
                ...
                <p class="hero-sub">
                    50 agents. 2 Months. Built, managed, and continuously upgraded by Airo. <br /> Supporting the most
          ...
          ">
            ...
            ">
                            ...
                            <g class="interactive-group" style="cursor: pointer" onclick="openSharedModal('phase1')">
                                ...
                                <text dy="6" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="14"
                                    font-weight="700">
                  ...
                  <tspan x="0" dy="16">Upgrade</tspan>
                                ...
                                <text fill="white" font-family="'Inter', sans-serif" font-size="15"
                                    text-anchor="middle">
                            ...
                            <g class="lit" filter="url(#s5-g2)">
                                <g class="interactive-group" style="cursor: pointer" onclick="openSharedModal('erp')">
                                    ...
                                    <text dy="8" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="18"
                                        ...
                                        <textPath href="#s5-s2p" startOffset="16.66%">ERP Use Cases </textPath>
                                    </text>
                                </g>
                                <g class="interactive-group" style="cursor: pointer" onclick="openSharedModal('crm')">
                                    ...
                                    <text dy="8" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="18"
                                        font-weight="800" text-anchor="middle" letter-spacing="3" pointer-events="none">
                                        <textPath href="#s5-s2p" startOffset="50%">CRM Use Cases </textPath>
                                    </text>
                                </g>
                                <g class="interactive-group" style="cursor: pointer" onclick="openSharedModal('scm')">
                                    ...
                                    <text dy="8" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="18"
                                        font-weight="800" text-anchor="middle" letter-spacing="3" pointer-events="none">
                                        <textPath href="#s5-s2p" startOffset="83.33%">SCM Use Cases </textPath>
                                    </text>
                                </g>
                            ...
                            <g class="lit" filter="url(#s5-g2)">
                                <g class="hover-stroke-group" style="cursor: pointer" onclick="openSharedModal('ind1')">
                                    ...
                                    <text dy="5" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="16"
    ...
    <script>
        (function () {
            ...
            const rows = [
                ...
                [
                    "Speed of Agent Deployment – 50 agents built in less than 2 months",
                    NO,
                    NO,
                    YES,
                ],
...
//       },
    ...
    <script>
        (function () {
            /* ─────────────────────────────────────────
               SLIDE ENGINE  (unchanged from original)
            ───────────────────────────────────────── */
            const slides = document.querySelectorAll(".slide");
            const dots = document.querySelectorAll(".dot");
            const chip = document.getElementById("slide-chip");
            ...
            function goTo(next) {
                ...
                const fcta = document.getElementById("fcta");
                next > 0 ? fcta.classList.add("show") : fcta.classList.remove("show");
                next === 3 ? fcta.classList.add("on-red") : fcta.classList.remove("on-red");
            ...
            function triggerCTA() {
                ["c5ey", "c5h", "c5s", "c5d", "c5b", "c5p"].forEach((id, i) => {
                    const el = document.getElementById(id);
                    if (!el) return;
                    setTimeout(() => { el.style.opacity = "1"; el.style.transform = "none"; }, i * 115);
                });
            }
            ...
            window.addEventListener("wheel", e => {
                ...
                // 2. Custom butter momentum scroll if target is scrollable
                if (activeSlide) {
                ...
                // 3. slide transition logic (only triggered if at boundaries, with high threshold/intentionality)
                e.preventDefault();
                wD += e.deltaY;
                clearTimeout(wT);
                wT = setTimeout(() => { 
                    if (Math.abs(wD) > 120) { // Increased threshold from 30 to 120 for extremely controlled feel
                        goTo(wD > 0 ? current + 1 : current - 1); 
                    } 
                    wD = 0; 
                }, 100);
            }, { passive: false });
            ...
            window.addEventListener("touchend", e => {
                ...
                // Trackpad horizontal swiping - ignore
                if (Math.abs(dx) > Math.abs(dy)) {
                    return;
                }
                
                if (Math.abs(dy) > 100) { // Increased swipe threshold from 40 to 100 for premium controlled mobile feel
                    const activeSlide = slides[current];
                    if (activeSlide) {
