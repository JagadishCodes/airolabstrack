...
<section id="banner">
	<div class="data-banner">
		<div class="data-row1">
			<div class="banner-details1" style="background-color:#E5E3CD;">
				<div class="banner-bg">
