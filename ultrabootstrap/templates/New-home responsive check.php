<?php
/**
 * Template Name: New Home Responsive check
...
.row.services-main .col-md-6.col-lg-4.col-sm-6 {
	...
	.services-tabs { gap: 5px; flex-direction: column; width: 100%; display: flex; max-width: 100%; min-width: 0; }	
	.ai-tab-title { width: 100% !important; display: block !important; box-sizing:border-box; max-width: 100%; min-width: 0; white-space: normal !important; overflow-wrap: break-word !important; word-wrap: break-word !important; }
    .services-tabs .services-title { padding:12px 10px !important; width:100% !important; box-sizing:border-box; display:block !important; max-width: 100%; min-width: 0; white-space: normal !important; }
	ul.services-tabs li.ai-tab-title .services-title h2{ 
	...
	.services-sec .services-inner { height: auto !important; padding: 20px; }	
	}
	/* ══ SECTION 03 — TRINITY ══ */
.s-trinity {
  padding: 60px 0 48px;
...
@media (max-width: 600px) {
  ...
  .s2-white, .s2-red { font-size: 16px; }
  .s2-arrow { width: 20px; }
  .s2-box { padding: 10px 16px; gap: 8px; }
}
...
<section class="s-ecosystem">
  ...
  <div class="eco-logo-item">
    <img src="/wp-content/uploads/2026/05/OpenAI_Logo.png" alt="OpenAI" loading="lazy">
  </div>

  <div class="eco-logo-item">
    <img src="/wp-content/uploads/2026/05/anthropic-1.png" alt="Anthropic" loading="lazy">
  </div>

  <div class="eco-logo-item">
    <img src="/wp-content/uploads/2026/05/googlevertexai-1.jpg" alt="Google" loading="lazy">
  </div>

  <div class="eco-logo-item">
    <img src="/wp-content/uploads/2026/05/copilot-1.png" alt="Microsoft" loading="lazy">
  </div>

  <div class="eco-logo-item">
    <img src="/wp-content/uploads/2026/05/amazon-bedrock-1-1-1.png" alt="Amazon" loading="lazy">
  </div>

  <div class="eco-logo-item">
    <img src="/wp-content/uploads/2026/05/cursor-3.png" alt="Cursor" loading="lazy">
  </div>
			...
			<ul class="services-tabs">
				...
				<?php if (!empty($platform_and_accelerators)) { ?>
					<li class="ai-tab-title <?php if (empty($ai_services_section)) echo 'ai-active'; ?>" data-tab="platform_and_accelerators">
						<div class="services-title">
							<h2>Platform and Accelerators</h2>
						</div>
					</li>
				<?php } ?>
			</ul>
