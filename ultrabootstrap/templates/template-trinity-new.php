...
<!--     <div class="dot" data-i="2"></div>
  ...
  <a href="https://calendly.com/airodigitallabs/30min?guests=sayak.das%40airodigitallabs.com&month=2026-05" id="fcta">
  ...
  <div id="stage">
    <div class="slide s0 active">
		<svg style="            position: absolute;            inset: 0;            width: 100%;            height: 100%;            opacity: 0.2;            pointer-events: none;          " viewBox="0 0 1000 560" preserveAspectRatio="xMidYMax slice">
      ...
      <div class="hero-inner">
        ...
        <h1 class="hero-h">
          Airo Agentic AI<br /><span>Trinity<sup>©</sup> Package</span>
        </h1>
        <p class="hero-sub">
          100 agents. 6 Months. Built, managed, and continuously upgraded by Airo
        </p>
        <div class="hero-dwrap">
          ...
          ">
            ...
            ">
              ...
              <g class="dim">
                <path d="M 280,500 A 220,220 0 0,1 720,500" fill="none" stroke="#e2e8f0" stroke-width="2"></path>
                <path d="M 180,500 A 320,320 0 0,1 820,500" fill="none" stroke="#e2e8f0" stroke-width="2"></path>
                <path d="M 80,500 A 420,420 0 0,1 920,500" fill="none" stroke="#e2e8f0" stroke-width="2"></path>
              </g>
...
<!--                   <tspan x="0" font-weight="700">Phase 1:</tspan> -->
                ...
                <text dy="6" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="14" font-weight="700">
              ...
              <g class="interactive-group" style="cursor: pointer" onclick="openSharedModal('phase2')">
                <path d="M 415,352.8 A 170,170 0 0,1 585,352.8" fill="none" stroke="#8c8c8c" stroke-width="80"></path>
                <text fill="white" font-family="'Inter', sans-serif" font-size="15" text-anchor="middle"
                  transform="translate(500, 330)">
<!--                   <tspan x="0" font-weight="700">Phase 2:</tspan> -->
                  <tspan x="0" dy="16">Managed</tspan>
                </text>
                <text dy="6" fill="#8c8c8c" font-family="'Inter', sans-serif" font-size="14" font-weight="700">
              ...
              <g class="interactive-group" style="cursor: pointer" onclick="openSharedModal('phase3')">
                <path d="M 585,352.8 A 170,170 0 0,1 670,500" fill="none" stroke="#e31837" stroke-width="80"></path>
                <text fill="white" font-family="'Inter', sans-serif" font-size="15" text-anchor="middle"
                  transform="translate(647.2, 415) rotate(60)">
<!--                   <tspan x="0" font-weight="700">Phase 3:</tspan> -->
                  <tspan x="0" dy="16">Upgrade</tspan>
                </text>
                <text dy="6" fill="#e31837" font-family="'Inter', sans-serif" font-size="14" font-weight="700">
              ...
              <line x1="395" y1="318.1" x2="435" y2="387.4" stroke="#ffffff" stroke-width="3" pointer-events="none">
              </line>
              <line x1="605" y1="318.1" x2="565" y2="387.4" stroke="#ffffff" stroke-width="3" pointer-events="none">
              </line>
              ...
              <g class="lit" filter="url(#s5-g2)">
                <g class="interactive-group" style="cursor: pointer" onclick="openSharedModal('erp')">
                  <path d="M 230,500 A 270,270 0 0,1 365,266.2" fill="none" stroke="#e31837" stroke-width="80"></path>
                  <text dy="8" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="24" font-weight="800"
                    text-anchor="middle" letter-spacing="3" pointer-events="none">
                    <textPath href="#s5-s2p" startOffset="16.66%">ERP</textPath>
                  </text>
                </g>
                <g class="interactive-group" style="cursor: pointer" onclick="openSharedModal('crm')">
                  <path d="M 365,266.2 A 270,270 0 0,1 635,266.2" fill="none" stroke="#e31837" stroke-width="80"></path>
                  <text dy="8" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="24" font-weight="800"
                    text-anchor="middle" letter-spacing="3" pointer-events="none">
                    <textPath href="#s5-s2p" startOffset="50%">CRM</textPath>
                  </text>
                </g>
                <g class="interactive-group" style="cursor: pointer" onclick="openSharedModal('scm')">
                  <path d="M 635,266.2 A 270,270 0 0,1 770,500" fill="none" stroke="#e31837" stroke-width="80"></path>
                  <text dy="8" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="24" font-weight="800"
                    text-anchor="middle" letter-spacing="3" pointer-events="none">
                    <textPath href="#s5-s2p" startOffset="83.33%">SCM</textPath>
                  </text>
                </g>
                <line x1="345" y1="231.5" x2="385" y2="300.8" stroke="#ffffff" stroke-width="3" pointer-events="none">
                </line>
                <line x1="655" y1="231.5" x2="615" y2="300.8" stroke="#ffffff" stroke-width="3" pointer-events="none">
                </line>
              </g>

              <g class="lit" filter="url(#s5-g2)">
                <g class="hover-stroke-group" style="cursor: pointer" onclick="openSharedModal('domain1')">
                  <path d="M 130,500 A 370,370 0 0,1 315,179.6" fill="none" stroke="#cbd5e1" stroke-width="80"
                    class="hs-bg"></path>
                  <text dy="6" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="18" font-weight="800"
                    text-anchor="middle" letter-spacing="1.5" pointer-events="none" class="hs-text">
                    <textPath href="#s5-s3p" startOffset="16.66%">
                      Most Use Case
                    </textPath>
                  </text>
                </g>
                <g class="hover-stroke-group" style="cursor: pointer" onclick="openSharedModal('domain2')">
                  <path d="M 315,179.6 A 370,370 0 0,1 685,179.6" fill="none" stroke="#cbd5e1" stroke-width="80"
                    class="hs-bg"></path>
                ...
                <g class="hover-stroke-group" style="cursor: pointer" onclick="openSharedModal('domain3')">
                  <path d="M 685,179.6 A 370,370 0 0,1 870,500" fill="none" stroke="#cbd5e1" stroke-width="80"
                    class="hs-bg"></path>
                  <text dy="6" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="18" font-weight="800"
                    text-anchor="middle" letter-spacing="1.5" pointer-events="none" class="hs-text">
                ...
                <line x1="295" y1="144.9" x2="335" y2="214.2" stroke="#ffffff" stroke-width="3" pointer-events="none">
                </line>
                <line x1="705" y1="144.9" x2="665" y2="214.2" stroke="#ffffff" stroke-width="3" pointer-events="none">
                </line>
              </g>

              <g class="lit" filter="url(#s5-g2)">
                <g class="hover-stroke-group" style="cursor: pointer" onclick="openSharedModal('ind1')">
                  <path d="M 35,500 A 465,465 0 0,1 171.2,171.2" fill="none" stroke="#f1f5f9" stroke-width="70"
                    class="hs-bg"></path>
                  <text dy="5" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="16" font-weight="800"
                    text-anchor="middle" letter-spacing="1" pointer-events="none" class="hs-text">
                ...
                <g class="hover-stroke-group" style="cursor: pointer" onclick="openSharedModal('ind2')">
                  <path d="M 171.2,171.2 A 465,465 0 0,1 500,35" fill="none" stroke="#f1f5f9" stroke-width="70"
                    class="hs-bg"></path>
                  <text dy="5" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="16" font-weight="800"
                    text-anchor="middle" letter-spacing="1" pointer-events="none" class="hs-text">
                ...
                <g class="hover-stroke-group" style="cursor: pointer" onclick="openSharedModal('ind3')">
                  <path d="M 500,35 A 465,465 0 0,1 828.8,171.2" fill="none" stroke="#f1f5f9" stroke-width="70"
                    class="hs-bg"></path>
                  <text dy="5" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="16" font-weight="800"
                    text-anchor="middle" letter-spacing="1" pointer-events="none" class="hs-text">
                ...
                <g class="hover-stroke-group" style="cursor: pointer" onclick="openSharedModal('ind4')">
                  <path d="M 828.8,171.2 A 465,465 0 0,1 965,500" fill="none" stroke="#f1f5f9" stroke-width="70"
                    class="hs-bg"></path>
                  <text dy="5" fill="#0b1f44" font-family="'Inter', sans-serif" font-size="16" font-weight="800"
                    text-anchor="middle" letter-spacing="1" pointer-events="none" class="hs-text">
                    <textPath href="#s5-s4p" startOffset="87.5%">BFSI</textPath>
                  </text>
                </g>
                <line x1="146.4" y1="146.4" x2="195.9" y2="195.9" stroke="#ffffff" stroke-width="3"
                  pointer-events="none"></line>
                <line x1="500" y1="0" x2="500" y2="70" stroke="#ffffff" stroke-width="3" pointer-events="none"></line>
                <line x1="853.6" y1="146.4" x2="804.1" y2="195.9" stroke="#ffffff" stroke-width="3"
                  pointer-events="none"></line>
              </g>

              <g transform="translate(0, -10)" pointer-events="none">
                <rect x="290" y="490" width="420" height="70" rx="8" fill="#ffffff" stroke="#e31837" stroke-width="2.5"
                  filter="drop-shadow(0px 8px 16px rgba(0,0,0,0.08))"></rect>
                <text x="500" y="525" font-family="'Roboto Slab', serif" font-size="22" font-weight="700" fill="#0b1f44"
                  text-anchor="middle">
                  Airo Agentic AI Trinity Package©
                </text>
                <text x="500" y="545" font-family="'Inter', sans-serif" font-size="13" font-weight="500" fill="#64748b"
                  text-anchor="middle">
          ...
          <style type="text/css">
            @media (max-width: 820px) {
              ...
              /* 1. Unlock Slide 5 height so it doesn't squish elements together */
              .slide.s5 {
                padding-top: 80px !important;
                /* Reduced from 120px to move it up */
              ...
              /* 2. Remove the extra margin on the text block to pull it even closer to the top */
              .slide.s5>div:nth-of-type(1) {
                order: 1 !important;
                margin-top: 0px !important;
                /* Reduced from 20px to 0px */
              }

              /* 2. Put the Text Area at the TOP */
              .slide.s5>div:nth-of-type(1) {
                order: 1 !important;
                /* Changed from 2 to 1 */
              ...
              /* 3. Put the Diagram BELOW the text */
              .slide.s5 .diagram-col {
                order: 2 !important;
                /* Changed from 1 to 2 */
              ...
              /* 4. Put the Buttons at the VERY BOTTOM */
              #c5b {
                order: 3 !important;
...
<!--             <button class="cta-btn" style="
            ...
            <button class="cta-btn" style="
              ...
              cursor: pointer;
            "
              onclick="window.open('https://calendly.com/airodigitallabs/30min?guests=sayak.das%40airodigitallabs.com&month=2026-05', '_blank')">
              Book a Demo
            </button>
          </div>
    ...
    <script>
      ...
      const modalContent = {
        ...
        erp: {
          ...
          items: [
            "Native Connectors for SAP, Oracle, and Microsoft Dynamics",
            "Autonomous Financial Reconciliation Agents",
            "Real-Time Resource & Inventory Syncing",
            "Automated Invoice & Procurement Processing",
            "Predictive Financial Forecasting & Analytics",
          ],
        },
        crm: {
          color: "#e31837", // Red
          ...
          items: [
            "Deep Integration with Salesforce, HubSpot, and Zendesk",
            "Agentic Lead Scoring & Routing",
            "Automated Hyper-Personalized Outreach",
            "360-Degree Customer View Agents",
            "Predictive Churn Analysis & Remediation",
          ],
        },
        scm: {
          color: "#e31837", // Red
          ...
          items: [
            "End-to-End Logistics Tracking Agents",
            "Automated Supplier Risk & Compliance Assessment",
            "Demand Forecasting & Predictive Maintenance",
            "Autonomous Purchase Order & Fulfillment Routing",
            "Dynamic Multi-Tier Inventory Optimization",
          ],
        },
        ...
        domain2: {
          ...
          items: [
            "Autonomous Document Processing & Data Entry",
            "Intelligent HR Onboarding & Query Handling",
            "Automated Compliance & Audit Reporting",
            "Agentic Procurement & Vendor Management",
        ...
        ind1: {
          ...
          items: [
            ...
            "Regulatory Compliance & Audit Trail Agents",
            "Supply Chain Cold-Storage Monitoring",
            "R&D Literature Review & Insight Extraction",
            "Predictive Drug Demand Forecasting",
          ],
        },
        ind2: {
          color: "#0b1f44",
          ...
          title: "Manufacturing",
          items: [
            "Predictive Machine Maintenance Agents",
            "Real-time Defect Detection & Triage",
            "Dynamic Production Floor Scheduling",
        ...
        ind3: {
          ...
          items: [
            ...
            "Omnichannel Inventory Balancing Agents",
            "Automated Returns & Dispute Handling",
        ...
        ind4: {
          ...
          title: "BFSI",
          items: [
            "Autonomous Fraud Detection & Triage",
            "KYC / AML Document Processing Agents",
            "Algorithmic Risk Scoring & Underwriting",
            "Conversational Wealth Management Bots",
            "Automated Loan Application Resolution",
          ],
        },
      };
    ...
    <div class="slide s6">
      <div class="cmp-wrap">
        <h2 class="cmp-title">
          Why Airo's Agentic Trinity<sup>©</sup> Package<br />Changes the
          Equation
        </h2>
        <div class="cmp-card">
  ...
  <style>
    ...
    .cmp-table tbody td {
      padding: clamp(7px, 1.2vh, 13px) 18px;
      font-size: 0.93rem;
      text-align: center;
  ...
  <script>
    (function () {
      ...
      const rows = [
        ...
        [
          "Speed of Execution – 100 agents built in less than 6 months",
          NO,
          NO,
          YES,
        ],
  ...
  <div id="shared-modal-overlay" class="modal-overlay hidden">
    <div id="shared-modal-box" style="--phase-color: #0b1f44">
      ...
      <p id="shared-modal-footer">
        Airo Agentic AI Trinity Package© · AI Use Case Lifecycle Management
      </p>
    </div>
  </div>
