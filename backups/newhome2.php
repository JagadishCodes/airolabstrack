...
══════════════════════════════ */
  ...
  @media(max-width: 767.98px) {
    ...
    .services-tabs .services-title h2 {
...
.s2-quote-text .r { color: var(--red); } */
  ...
  .services-title h2 a {
    color: inherit;
    /* keeps the h2's existing color */
    text-decoration: none;
    /* removes underline */
    display: block;
    /* makes the full area clickable */
  }
...
*/
  ...
  @media (min-width: 1024px) {
    .home-banner-sec {
      height: min(calc(100dvh - 175px), 900px);
      /* cap at 900px — keeps 4K sane */
      min-height: 400px;
      overflow: hidden;
      display: flex;
      align-items: stretch;
...
<style>
  ...
  .custom-banner-card {
    background: linear-gradient(135deg, #f0f4fd 0%, #ffffff 40%, #e8f0fe 100%);
    width: 100%;
  ...
  .t-feat-text strong.red {
    color: var(--red, #ff0000);
  }

  .t-feat-text strong.blue {
    color: var(--blue-dark, #0035cc);
  }
  ...
  /* Secondary Banner */
  .choose-pkg-banner {
    background: linear-gradient(135deg, var(--blue, #0D004A) 0%, var(--blue-dark, #0035cc) 100%);
    color: #fff;
    padding: 50px 60px;
    display: flex;
    flex-direction: column;
  ...
  .choose-pkg-banner:hover {
    transform: translateY(-5px);
    box-shadow: 0 20px 40px rgba(0, 53, 204, 0.3);
  }
...
<section class="custom-banners-wrapper">
  <div class="container-fluid" style="padding: 0;">
    ...
    <div class="hero-main-carousel">
        ...
        <div class="custom-banner-card">
          <div class="triniti-banner-inner">
            <div class="triniti-left">
              ...
              <div class="triniti-product">Airo's <span class="highlight">agenTriniti</span> Package</div>
              ...
              <div class="triniti-footer">
                <div class="t-partners">
                  <span>In partnership with</span>
                  <strong style="color: #111; font-size: 15px;">ANTHROPIC</strong> |
                  <strong style="color: #111; font-size: 15px;">OpenAI</strong>
                </div>
              </div>
            </div>
            <div class="triniti-right">
              <img src="https://dev.airolabs.ai/wp-content/uploads/2026/07/trinity_arc_animated.svg" alt="Triniti Arc"
                class="triniti-svg">
            </div>
          </div>
        </div>
      ...
      <div class="carousel-slide-item">
        <a href="/capabilities/airos-agentriniti-package/" class="custom-banner-card choose-pkg-banner">
          <h3>Choose Your Package</h3>
          <p>Explore our transparent, flat-rate tiers designed to scale with your enterprise.</p>
          <span class="btn-explore">Explore Packages</span>
        </a>
      </div>

      <!-- Slide 3: Image Banner -->
      <div class="carousel-slide-item">
        <div class="custom-banner-card p-0" style="border:none; box-shadow:none;">
          <img src="https://dev.airolabs.ai/wp-content/uploads/2026/04/Proud_to_be_a__14___1__no_logo.png"
  ...
  document.addEventListener("DOMContentLoaded", function () {
    if (jQuery().slick) {
      ...
      $carousel.slick({
        ...
        swipe: true,
        touchMove: true,
        adaptiveHeight: false // keep them equal height
      });
    }
  });
</script>
...
<section class="hero-client-logos-sec"
  style="padding: 20px 0; background: #fff; border-bottom: 1px solid var(--border); overflow: hidden;">
  <div class="container-fluid" style="padding: 0;">
    <div class="hero-client-logos">
      ...
      foreach ($new_logos as $new_logo_url) {
        ...
        ?>
        <div class="logo-item"
          style="padding: 0 15px; text-align: center; outline: none; display: flex; align-items: center; justify-content: center; height: 70px;">
          <img src="<?php echo esc_url($new_logo_url); ?>" alt="<?php echo esc_attr($alt_text); ?>"
            style="width: <?php echo $img_width; ?>; height: <?php echo $img_height; ?>; object-fit: contain; margin: 0 auto; filter: grayscale(100%) opacity(0.5); transition: all 0.3s ease;<?php echo $extra_style; ?>">
        </div>
      <?php } ?>
    </div>
  </div>
  ...
  <div class="container" style="padding-left: 15px !important; padding-right: 15px !important;">
    <div class="ecosystem-header" style="margin-bottom: 20px; text-align: center;">
      <h2 class="intro-headline"
        style="font-size: clamp(32px, 4vw, 48px); padding-bottom: 0; margin-bottom: 15px; text-align: center !important; text-transform: none; letter-spacing: normal !important; word-spacing: normal !important; line-height: 1.3 !important;">
        Airo's <span style="color: var(--red); white-space: nowrap;">agenTriniti Package</span></h2>
      <p class="eyebrow" style="justify-content: center; color: var(--red); margin-bottom: 15px;">AI Use Case Lifecycle
        Management</p>
    </div>
    <div class="row">
      <div class="col-12 text-center">
        ...
        <video
          style="width: 100%; max-width: 100%; aspect-ratio: 16/9; border-radius: 8px; box-shadow: 0 12px 40px rgba(0,0,0,0.15); display: inline-block; background-color: #000;"
          id="new-player-2" controls playsinline preload="metadata" muted>
...
<div class="s-intro">
  ...
  <div class="s-intro-right">
    ...
    <p class="intro-body">
      Airo’s agenTriniti package integrates deployment, governance, and continuous AI evolution into one operational
      system designed for enterprise scale.<br>Built to orchestrate AI across enterprise workflows, legacy systems, and
      agent ecosystems while eliminating fragmented delivery, vendor lock-in, and operational complexity.
    </p>
    ...
    <div class="trinity-ctas">
      <a href="/capabilities/airos-agentriniti-package/" class="trinity-btn-primary text-wrap text-center"
        style="white-space: normal; height: auto; line-height: 1.4; padding-top: 10px; padding-bottom: 10px; text-transform: none;">
...
<section class="s-ecosystem">
  <div class="container">
    ...
    <div class="ecosystem-header">
      ...
      <p class="ecosystem-copy">From ERP and CRM to cloud, data, and AI infrastructure, Airo connects where your
        enterprise already operates.</p>
    </div>
  ...
  <section class="services-sec">
    ...
    <div id="container" class="container">
      <div class="lines">
        ...
        <ul class="services-tabs">
          <?php if (!empty($ai_services_section)) { ?>
            <li class="ai-tab-title ai-active" data-tab="advanced-ai">
              <div class="services-title">
                <h2><a href="/capabilities/airos-agentriniti-package/"> Airo's agenTriniti Package</a></h2>
              </div>
            </li>
          <?php } ?>
          <?php if (!empty($cloud_services_section)) { ?>
            <li class="ai-tab-title <?php if (empty($ai_services_section))
              echo 'ai-active'; ?>" data-tab="foundational-ai">
              <div class="services-title">
          ...
          <?php if (!empty($premium_enterprise_application)) { ?>
            <li class="ai-tab-title <?php if (empty($ai_services_section))
              echo 'ai-active'; ?>" data-tab="premium_enterprise">
              <div class="services-title">
          ...
          <?php if (!empty($platform_and_accelerators)) { ?>
            <li class="ai-tab-title <?php if (empty($ai_services_section))
              echo 'ai-active'; ?>" data-tab="platform_and_accelerators">
              <div class="services-title">
                <h2>Platforms</h2>
              </div>
            </li>
      ...
      <div class="ai-tab-contents">
                      ...
                      <div class="arrow-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="29.657" height="11.314" viewBox="0 0 29.657 11.314"
                          ...
                          <g transform="translate(-125.992 -0.208)">
                            ...
                            <path d="M7.9,7.994,8,2.482A2.424,2.424,0,0,0,5.512-.006L0,.1Z"
        ...
        <?php if (!empty($cloud_services_section)) { ?>
          <div class="ai-tab-content <?php if (empty($ai_services_section))
            echo 'ai-active'; ?>" id="foundational-ai">
        ...
        <?php if (!empty($premium_enterprise_application)) { ?>
          <div class="ai-tab-content <?php if (empty($ai_services_section))
            echo 'ai-active'; ?>" id="premium_enterprise">
        ...
        <?php if (!empty($platform_and_accelerators)) { ?>
          <div class="ai-tab-content <?php if (empty($ai_services_section))
            echo 'ai-active'; ?>" id="platform_and_accelerators">
        ...
        <nav>
          <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
            <?php foreach ($ai_imapct_section['tabs'] as $tab_key => $tab) { ?>
              <button class="nav-link <?php if ($tab_key == 0) {
                echo 'active';
              } ?>" id="nav-<?php echo preg_replace('/[^A-Za-z0-9\-]/', '', $tab['title']); ?>-tab"
                data-bs-toggle="tab"
                data-bs-target="#nav-<?php echo preg_replace('/[^A-Za-z0-9\-]/', '', $tab['title']); ?>" type="button"
                role="tab" aria-controls="nav-<?php echo preg_replace('/[^A-Za-z0-9\-]/', '', $tab['title']); ?>"
                aria-selected="true"><?php echo $tab['title']; ?> </button>
            <?php } ?>
          </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
          <?php foreach ($ai_imapct_section['tabs'] as $tab_key => $tab) { ?>
            <div class="tab-pane fade <?php if ($tab_key == 0) {
              echo 'active show';
            } ?>" id="nav-<?php echo preg_replace('/[^A-Za-z0-9\-]/', '', $tab['title']); ?>" role="tabpanel"
              aria-labelledby="nav-<?php echo preg_replace('/[^A-Za-z0-9\-]/', '', $tab['title']); ?>-tab">
              <?php $post_type = $tab['tabs_post']; ?>
              <div class="impact-slider">
                <?php if ($post_type) {
                  foreach ($post_type as $key => $postinner) { ?>
...
<?php if ($ai_race_section['title']) { ?>
  <section class="fixed-sec">
    <div class="fixed-sec-inner"
      style="background-image: url('<?php echo $ai_race_section['background_image']['url']; ?>');">
      <div class="container-l-auto">
          ...
          <div class="my-slick-arrows color-white">
            <button class="race-prev slick-prev slick-arrow" style="transform: rotate(90deg);">
              <svg xmlns="http://www.w3.org/2000/svg" width="12.558" height="12.558" viewBox="0 0 12.558 12.558">
                <path id="icn-dropdown" d="M125.882,8.882V2.8a2.8,2.8,0,0,0-2.8-2.8H117Z"
                  transform="translate(95.292 -76.452) rotate(135)" fill="#fff" />
              </svg>
            </button>
      ...
      <div class="blog-main">
        ...
        <?php foreach ($event as $key => $events) { ?>
          <div class="blog-inner event-inner">
            ...
            <a href="<?php echo get_permalink($events->ID); ?>">
              <h3 class="blog-title"><?php echo $events->post_title; ?></h3>
            </a>
            <?php
            $event_desc = '';
  ...
  <section class="question-sec">
    <div class="container">
      <div class="question-inner">
        <img src="<?php echo $ai_innovation_section['image']; ?>" alt="<?php echo $ai_innovation_section['title']; ?>"
          class="desktop" loading="lazy">
        <?php if ($ai_innovation_section['image_for_mobile']) { ?>
          <img src="<?php echo $ai_innovation_section['image_for_mobile']; ?>"
            alt="<?php echo $ai_innovation_section['title']; ?>" class="mobile" loading="lazy">
        <?php } else { ?>
          <img src="<?php echo $ai_innovation_section['image']; ?>" alt="<?php echo $ai_innovation_section['title']; ?>"
            class="mobile" loading="lazy">
        <?php } ?>
        <div class="row">
          ...
          <div class="col-lg-7 col-md-6 col-sm-12 question-right">
            ...
            <a href="<?php echo $ai_innovation_section['button_link']['url']; ?>"
              target="<?php echo $ai_innovation_section['button_link']['target']; ?>"
              class="mybtn"><?php echo $ai_innovation_section['button_text']; ?></a>
          </div>
        </div>
      </div>
      <div class="lines"></div>
    ...
    <div class="container desktop">
      <div class="row">
        <div class="col-md-10 col-sm-10 col-xs-10 p-0">
          <img src="<?php echo $ai_join_us_section['image']['url']; ?>"
            alt="<?php echo $ai_join_us_section['image']['alt']; ?>" class="img_width desktop" loading="lazy">
          <?php if ($ai_join_us_section['image_for_mobile']) { ?>
            <img src="<?php echo $ai_join_us_section['image_for_mobile']['url']; ?>"
              alt="<?php echo $ai_join_us_section['image_for_mobile']['alt']; ?>" class="img_width mobile" loading="lazy">
          <?php } else { ?>
            <img src="<?php echo $ai_join_us_section['image']['url']; ?>"
              alt="<?php echo $ai_join_us_section['image']['alt']; ?>" class="img_width mobile" loading="lazy">
          <?php } ?>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-2 col-sm-2 col-xs-2 p-0 bl bb">
          <img src="<?php echo $ai_join_us_section['image_2']['url']; ?>"
            alt="<?php echo $ai_join_us_section['image_2']['alt']; ?>" class="img_width" loading="lazy">
        </div>
      </div>
      <div class="row">
        <div class="col-md-10 col-sm-10 col-xs-10 p-0 full-btn">
          <a href="<?php echo $ai_join_us_section['button_link']['url']; ?>"
            target="<?php echo $ai_join_us_section['button_link']['target']; ?>"
            class="mybtn"><?php echo $ai_join_us_section['button_text']; ?></a>
        </div>
